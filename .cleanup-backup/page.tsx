          ...
          <div className="text-center max-w-5xl mx-auto">
            ...
            <div className="sanctuary-glass border border-sanctuary/30 rounded-3xl p-phi-xs shadow-floating backdrop-blur-xl inline-flex items-center space-x-phi-xs animate-sanctuary-float">
              <button
                ...
                className={`px-phi-lg py-phi-sm rounded-2xl text-phi-sm font-light transition-all duration-400 tracking-wide ${
          ...
          {sanctuaryOfferings.map((offering, index) => (
            ...
            >
              ...
              <div className={`p-phi-xl ${offering.is_premium ? 'pt-phi-2xl pb-phi-xl' : 'pt-phi-xl pb-phi-lg'} text-center`}>
                <h2 className={`text-phi-xl font-light tracking-wide mb-phi-lg animate-gentle-breathe ${
                ...
                <div className="mb-phi-lg">
                  <div className="flex items-baseline justify-center mb-phi-sm">
                    <span className={`text-phi-3xl md:text-8xl font-extralight tracking-wide animate-gentle-pulse ${
                      offering.is_premium ? 'text-sage-700' : 'text-sage-800'
                    }`}>
                      {offering.investment}
                    </span>
                    <span className={`ml-phi-sm text-phi-md font-light tracking-wide ${
                ...
                <p className={`text-phi-base leading-relaxed mb-phi-lg font-light tracking-wide ${
