  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#8B9A7C] to-[#A8B5A0] flex flex-col px-6 relative">
      ...
      <div className="pt-16 pb-8 flex items-center">
        ...
        <h1 className="text-3xl text-white font-extralight tracking-[0.2em]">Journal</h1>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center max-w-[320px]">
          ...
          <h2 className="text-white text-xl font-light mb-4">Your Sacred Space</h2>
          <p className="text-white/60 text-sm mb-8">Express your thoughts and feelings with Khepera's gentle guidance</p>
          <Link 
            href="/journal/new"
