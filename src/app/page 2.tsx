    ...
    <main className="min-h-screen bg-[#f7f7f2] text-[#2e2e2e] flex flex-col items-center justify-center px-4 py-8">
      ...
      <section className="max-w-2xl text-center space-y-4">
        ...
        <div className="w-full mt-6">
          <div className="bg-gradient-to-r from-[#a4b792] to-[#cb997e] rounded-lg shadow-lg mx-auto h-64 flex items-center justify-center text-white text-lg font-medium">
            Your peaceful reflection space awaits 🌸
          </div>
        </div>
      </section>
