    ...
    <SanctuaryLayout header={<SanctuaryHeader title="Join ALCHM" showBack />}>
      <div style={{ minHeight: '65vh', display: 'grid', placeItems: 'center' }}>
        <SanctuaryCard elevated style={{ width: '100%', maxWidth: 420, textAlign: 'center' }}>
          <SanctuaryText variant="title" style={{ marginBottom: DESIGN.spacing.xs }}>Create an Account</SanctuaryText>
          <SanctuaryText variant="caption" style={{ marginBottom: DESIGN.spacing.md }}>Create your private writing space</SanctuaryText>
