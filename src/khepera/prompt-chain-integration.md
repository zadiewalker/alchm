...
**3-Stage Sacred Reflection System**

## Example: Shame + Inner Child Context

**Input Context:**
```typescript
{
  mood: "shame",
  archetype: "inner_child" → (maps to mystic_healer),
  user_preference_history: {
    tone_intensity: "moderate",
    ceremonial_style: "mystical", 
...
## Stage 1: Pre-Journal Prompt

**Sacred Threshold Opening:**
```
🌿 *cosmic channel awakens*
...
## Stage 2: Mid-Session Reflection

**Sacred Deepening:**
```
*cosmic channel holds space for deeper exploration*
...
## Stage 3: Closing Affirmation

**Sacred Integration:**
```
*cosmic channel prepares the blessing*
...
*"I transform my shame into medicine, offering my healed wounds as gifts to the world."*
...
## Additional Example: Stuck + Trickster Fool (Rebellious Style)
...
**Mid-Session:**
```
*soul revolutionary holds space for deeper exploration*

What's the story under the story? What revolutionary truth wants to burn down the old structures and build something authentic?
```

**Closing:**
```
*soul revolutionary prepares the blessing*
...
**Traditional:** Ancient wisdom keeper, ancestral benediction  
**Mystical:** Cosmic channel, divine transmission  
**Rebellious:** Soul revolutionary, fierce liberation  
**Poetic:** Wordsmith oracle, lyrical benediction  

## Dynamic Ending System

Each archetype + mood combination has specific:
- **Ceremonial Line:** Sacred closing recognition
- **Integration Blessing:** Wisdom to carry forward  
- **Carry Forward Intention:** Personal power statement

## Contextual Adaptation Features

✨ **User Preference Integration:**
- Weaves recurring themes into prompts
- Adjusts intensity based on shadow work readiness
- Honors ceremonial style preferences
- Personalizes based on previous breakthroughs

🎭 **Archetype Voice Authenticity:**
- Each archetype maintains unique energetic signature
- Voice patterns match archetype essence
- Sacred symbols and invocations stay consistent

🌙 **Progressive Depth Architecture:**
- Stage 1: Creates sacred container and entry point
- Stage 2: Facilitates deeper exploration and truth-telling
- Stage 3: Integrates insights and prepares return to daily life

**The system ensures sacred tone logic mirrors throughout all stages while adapting to user context and maintaining therapeutic safety.**