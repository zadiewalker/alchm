...
export function middleware(request: NextRequest) {
  ...
  const cspPolicy = [
    "default-src 'self'",
    "script-src 'self' 'unsafe-inline' https://www.googleapis.com https://*.firebase.com https://*.firebaseapp.com",
    "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
    "font-src 'self' https://fonts.gstatic.com",
    "img-src 'self' data: https://*.firebase.com https://*.firebaseapp.com blob:",
    "connect-src 'self' https://*.firebase.com https://*.firebaseapp.com wss://*.firebase.com",
    "frame-src 'none'",
    "object-src 'none'",
    "base-uri 'self'",
    "form-action 'self'",
  ...
  if (request.nextUrl.pathname.includes('/admin') || 
      request.nextUrl.pathname.includes('/journal') ||
      request.nextUrl.pathname.includes('/crisis')) {
