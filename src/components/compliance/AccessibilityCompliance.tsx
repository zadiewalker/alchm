    ...
    <div className="bg-white rounded-lg border border-gray-200">
      <div className="border-b border-gray-200 p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="text-xl font-medium text-gray-900">Accessibility Compliance</h3>
              <p className="text-gray-600">WCAG 2.1 AA compliance and user preferences</p>
            </div>
          </div>
          <div className="text-right">
            <div className="text-2xl font-medium text-green-600">{getComplianceScore()}%</div>
      ...
      <div className="p-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <h4 className="font-medium text-gray-900">Compliance Features</h4>
              <button
                onClick={runAllTests}
        ...
        <div className="mt-8 p-6 bg-blue-50 border border-blue-200 rounded-lg">
          <h4 className="font-medium text-blue-900 mb-4">WCAG 2.1 Compliance Summary</h4>
