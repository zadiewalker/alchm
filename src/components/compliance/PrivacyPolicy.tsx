...
export function PrivacyPolicy({ variant = 'full', showExportOptions = true }: PrivacyPolicyProps) {
  ...
  const TableOfContents = () => (
    <div className="bg-gray-50 p-4 rounded-lg mb-6">
      <h3 className="font-medium text-gray-800 mb-3">Privacy Policy Contents</h3>
  ...
  const PrivacyOverview = () => (
    <section id="overview" className="mb-8">
      <h2 className="text-xl font-medium text-gray-900 mb-4">Privacy Overview</h2>
      <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
        <h3 className="font-medium text-green-800 mb-3">🛡️ Privacy-First Design</h3>
  ...
  const DataCollection = () => (
    <section id="collection" className="mb-8">
      ...
      <div className="space-y-6">
        <div>
          <h3 className="text-lg font-medium text-gray-800 mb-3">Information We Collect</h3>
          <div className="grid grid-cols-1 gap-4">
            {privacyData.dataCollection.collected.map((item, index) => (
              <div key={index} className="border border-gray-200 rounded-lg p-4">
                <h4 className="font-medium text-gray-900 mb-2">{item.type}</h4>
        ...
        <div>
          <h3 className="text-lg font-medium text-gray-800 mb-3">Information We DON'T Collect</h3>
  ...
  const UserRights = () => (
    <section id="rights" className="mb-8">
      <h2 className="text-xl font-medium text-gray-900 mb-4">Your Privacy Rights</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {privacyData.userRights.map((right, index) => (
          <div key={index} className="border border-gray-200 rounded-lg p-4">
            <h3 className="font-medium text-gray-900 mb-2">{right.right}</h3>
      ...
      {showExportOptions && (
        <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
          <h3 className="font-medium text-green-800 mb-3">Exercise Your Rights Now</h3>
  ...
  const ChildrensPrivacy = () => (
    <section id="children" className="mb-8">
      <h2 className="text-xl font-medium text-gray-900 mb-4">Children's Privacy (COPPA Compliance)</h2>
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
        <h3 className="font-medium text-yellow-800 mb-3">Important Information for Parents</h3>
  ...
  if (variant === 'summary') {
    return (
      <Card className="max-w-2xl mx-auto">
        <CardHeader>
          <h2 className="text-xl font-medium">Privacy Summary</h2>
        </CardHeader>
        <CardContent>
          <PrivacyOverview />
          <div className="mt-4">
