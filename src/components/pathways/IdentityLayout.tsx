...
import animationData from "../../animations/identity_butterfly_morph.json";
...
export default function IdentityLayout({ config }: Props) {
  return (
    <div
    ...
    >
      ...
      <div className="max-w-xl mx-auto text-center mt-6">
        <p className="text-md text-gray-700">
          ...
          Who are you becoming today, and what does that look like?
        </p>
      </div>
    </div>
  );
