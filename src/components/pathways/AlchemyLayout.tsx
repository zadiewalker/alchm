...
import animationData from "../../animations/alchemy_fire_transmute.json";
...
export default function AlchemyLayout({ config }: Props) {
  return (
    <div
    ...
    >
      ...
      <div className="max-w-xl mx-auto text-center mt-6">
        <p className="text-md text-gray-700">
          ...
          What challenge or pain are you transmuting into power today?
        </p>
      </div>
    </div>
  );
