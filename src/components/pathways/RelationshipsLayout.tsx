...
import animationData from "../../animations/relationships_heart_sync.json";
...
export default function RelationshipsLayout({ config }: Props) {
  return (
    <div
    ...
    >
      ...
      <div className="max-w-xl mx-auto text-center mt-6">
        <p className="text-md text-gray-700">
          ...
          What relationship needs your nurturing and presence today?
        </p>
      </div>
    </div>
  );
