      ...
      <div className="fixed inset-0 z-50 bg-black bg-opacity-95 flex items-center justify-center p-4">
        <Card className="max-w-2xl w-full">
          <CardHeader className="bg-red-50 border-b border-red-200">
            <h2 className="text-xl font-bold text-red-800">Parental Consent Required</h2>
            ...
            {!parentalConsent.verificationSent ? (
              <div className="space-y-4">
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  <h3 className="font-semibold text-yellow-800 mb-2">Parent/Guardian Verification Required</h3>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex items-start justify-between">
            <div className="flex-1 mr-4">
              <h3 className="font-semibold text-gray-900 mb-1">{activeBanner.title}</h3>
        ...
        <Card className="max-w-4xl w-full max-h-[90vh] overflow-y-auto">
          <CardHeader className="bg-blue-50 border-b">
            <div className="flex justify-between items-center">
              <div>
                <h2 className="text-xl font-bold">Consent Management Center</h2>
          ...
          <CardContent className="p-6 space-y-6">
            ...
            <div className="border-t pt-6">
              <h3 className="text-lg font-semibold mb-4">Consent Management Options</h3>
