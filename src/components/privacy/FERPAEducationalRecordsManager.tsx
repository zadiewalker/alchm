    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl p-6 shadow-lg border-2 border-purple-200">
        <div className="flex items-start gap-3 mb-4">
          ...
          <div>
            <h3 className="text-xl font-medium text-purple-800">FERPA Educational Records Management</h3>
          ...
          <div className="bg-purple-50 rounded-lg p-4 mb-4">
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-4">
              <div className="bg-blue-50 rounded-lg p-3 border border-blue-200">
                <div className="text-lg font-medium text-blue-800">{educationalRecords.length}</div>
                <div className="text-sm text-blue-600">Educational Records</div>
              </div>
              <div className="bg-red-50 rounded-lg p-3 border border-red-200">
                <div className="text-lg font-medium text-red-800">{complianceStatus.violations.length}</div>
                <div className="text-sm text-red-600">Violations Found</div>
              </div>
              <div className="bg-yellow-50 rounded-lg p-3 border border-yellow-200">
                <div className="text-lg font-medium text-yellow-800">{complianceStatus.recommendations.length}</div>
        ...
        <div className="bg-gray-50 rounded-lg p-4 mb-4">
          <h4 className="font-medium text-gray-800 mb-2">📚 Educational Context</h4>
      ...
      <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
        <h4 className="font-medium text-blue-800 mb-2">ℹ️ Your FERPA Rights</h4>
