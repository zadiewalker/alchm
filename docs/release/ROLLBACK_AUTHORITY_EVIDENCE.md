...
`RECORDED FOR ANTHROPIC-BOUND KHEPERA CANDIDATE`
...
| Authoritative candidate SHA | `62d5a383e5404633dc5ab3d04e813b3cdeeedb4f` |
| Evidence-tail SHA | Runtime-attestation evidence commit containing this record |
| Firebase project | `alchm-463017` |
| Current Vercel production deployment | `dpl_6smNjSnhdYGHNEWAqevVSfVEegYD` |
| Vercel rollback target | `dpl_7Ha2hAsHqqhBtPHa2q6XhGMqySEd` |
...
| --- | --- |
| Vercel production | Current production is `dpl_6smNjSnhdYGHNEWAqevVSfVEegYD`; rollback target is `dpl_7Ha2hAsHqqhBtPHa2q6XhGMqySEd`. |
...
| Provider secret | Provider-secret binding is verified for this candidate. Any future provider-secret configuration or rotation requires a new lineage digest and verifier receipt. |
...
```bash
vercel rollback dpl_7Ha2hAsHqqhBtPHa2q6XhGMqySEd
