...
| Authoritative candidate SHA | `ba21195ad0b7feff7e3cd8aeb7e04966ad8ccf30` |
| Evidence-tail SHA | Runtime-attestation evidence commit containing this record |
| Firebase project | `alchm-463017` |
| Current Vercel production deployment | `dpl_AcCFEEPfBALMwWLsf783dmUf5E9E` |
...
| --- | --- |
| Vercel production | Current production is `dpl_AcCFEEPfBALMwWLsf783dmUf5E9E`; rollback target is `dpl_ED8GSN71szSE7TYq6pCLtAiDKA9A`. |
...
| Native RevenueCat | Revert product candidate `ba21195ad0b7feff7e3cd8aeb7e04966ad8ccf30` or archive a prior candidate without `@revenuecat/purchases-capacitor`. |
